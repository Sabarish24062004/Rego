(function($){'use strict';
  ...
  function applyFilters() {
    ...
    $('.rego_news_card').each(function() {
      var $c   = $(this);
      var type = ($c.attr('data-type')  || 'news').toLowerCase();
    ...
    // Hide pagination while a search query is live (search spans all pages)
  ...
  function buildPaginationModel(current) {
    // Returns the list of items (numbers and ellipses) to show.
    // Spec mirrors the screenshots:
    //   page 1:  ← Prev  1 2 3 … 19  Next →
    //   page 3:  ← Prev  1 2 3 4 5 … 19  Next →
    //   page 4:  ← Prev  1 2 3 4 5 6 … 19  Next →
    //   page 5+: ← Prev  1 … (c-2) (c-1) c (c+1) (c+2) … 19  Next →
    var items = [];
    var c = current;
